    ...
    <div class="row my-2" id="servicio">
        <article class="col">
            <h1 class="text-center border-bottom">LavaTú</h1>
            <v-container>
                <v-row>
                    <v-col>
                        <v-card shaped>
    ...
    <div class="row my-2" id="nosotros">
        <article class="col">
            <h2 class="text-center border-bottom">Conocenos</h2>
                <v-container>
                    <v-row>
                        <v-col>
                            <v-img src="https://via.placeholder.com/300x300?text=Lavatu"></v-img>
                        ...
                        <v-col>
                            <h3 class="text-center border-bottom">¿Quienes somos?</h3>
                    ...
                    <h3 class="text-center border-bottom">Nuestros Equipos</h3>
                    <v-row class="my-2">
    ...
    <div class="row my-2 justify-content-center" id="contacto">
        <article class="col-md-6">
            <v-card class="p-4">
                <h2 class="border-bottom text-center">Contactanos</h2>
                <form>
    ...
    <div class="row my-2">
        <article class="col">
            <h2 class="text-center border-bottom">Comentarios de nuestros clientes</h2>
            <div class="container">
    ...
    <div class="row my-2 justify-content-center">
        <article class="col-md-8">
            <v-card class="p-4 d-flex flex-column justify-content-center">
                <h2 class="border-bottom text-center">¿Que esperas?</h2>
